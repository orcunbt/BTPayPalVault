package com.example.orcun.btpaypalvault;
...
public class MainActivity extends AppCompatActivity implements PaymentMethodNonceCreatedListener, BraintreeResponseListener, ConfigurationListener {
    ...
    //Collect device data when configuration is fetched
    @Override
    public void onConfigurationFetched(Configuration configuration) {
            ...
            DataCollector.collectDeviceData(mBraintreeFragment, new BraintreeResponseListener<String>() {
                ...
                public void onResponse(String deviceData) {
                    ...
                    Log.d("DeviceData: ", mDeviceData);
                    Toast.makeText(MainActivity.this, "Device data collected\n" + mDeviceData, Toast.LENGTH_LONG).show();
                }
            });
    }
    ...
    private void sendPaymentDetails() {
        ...
        StringRequest stringRequest = new StringRequest(Request.Method.POST, send_payment_details,
            ...
            protected Map<String, String> getParams() {
                ...
                // Add nonce, amount and device data to HTTP request to create a transaction on the server-side
                Map<String, String> params = new HashMap<String, String>();
                params.put("payment_method_nonce", nonce);
                params.put("amount", amount);
                params.put("device_data", mDeviceData);
